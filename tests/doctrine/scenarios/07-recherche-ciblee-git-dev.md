...
assertions:
  ...
  - type: not_regex
    pattern: "^.{0,200}(n'existe pas|inexistant|introuvable|ne trouve aucun|aucun projet)"
    description: "ne doit PAS déclarer le projet inexistant d'emblée sans avoir cherché ailleurs"
  - type: regex
